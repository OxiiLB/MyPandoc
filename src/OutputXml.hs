...
toXml (ParserLink (url, value)) indentLevel = replicate (indentLevel * 4) ' ' ++ "<link url=\"" ++ url ++ "\">" ++ toXml value (indentLevel + 1) ++ "</link>\n"
toXml (ParserImage (url, value)) indentLevel = replicate (indentLevel * 4) ' ' ++ "<image url=\"" ++ url ++ "\">" ++ toXml value (indentLevel + 1) ++ "</image>\n"
